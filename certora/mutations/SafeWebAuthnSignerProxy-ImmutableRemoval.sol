...
contract SafeWebAuthnSignerProxy {
     ...
     */
    uint256 internal _X;  // Certora BUG: Not immutable 

    /**
     * @notice The y coordinate of the P-256 public key of the WebAuthn credential.
     */
    uint256 internal _Y;  // Certora BUG: Not immutable
    ...
    /** 
     * Certora BUG: A function that changes x and y.
     */
    function changeXY(uint256 x, uint256 y) external {
        _X = x;
        _Y = y;
    }
