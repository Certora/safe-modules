...
contract SafeWebAuthnSignerProxy {
    ...
    fallback() external payable {
        ...
        address insteadOfSingleton = address(100);  // certora BUG: Another random address.
        uint256 x = _X;
        uint256 y = _Y;
        ...
        assembly {
            ...
            let success := delegatecall(gas(), insteadOfSingleton, data, add(calldatasize(), 0x56), 0, 0)  // Certora BUG: Calling the other address.
